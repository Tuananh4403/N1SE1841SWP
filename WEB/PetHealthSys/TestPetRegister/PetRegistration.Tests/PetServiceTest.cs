...
namespace PetRegistration.Tests
{
    public class PetServiceTests
    {
        ...
        {
            var pet = new Pet("", "Dog", "Male", "Canine", "2024-07-01");
        ...
        {
            var pet = new Pet("Bo", "Dog", "Male", "Canine", "2024-07-01");
            var result = _petService.RegisterPet(pet);
        ...
        {
            var pet = new Pet("Bobby1", "Dog", "Male", "Canine", "2024-07-01");
            var result = _petService.RegisterPet(pet);
        ...
        {
            var pet = new Pet("Bobby", "", "Male", "Canine", "2024-07-01");
            var result = _petService.RegisterPet(pet);
