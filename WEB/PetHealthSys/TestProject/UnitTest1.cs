...
public class AuthServiceTests
{
    ...
    public async Task RegisterAsync_ValidCustomerRegistration_AddsUserAndCustomer()
    {
        ...
        _mockCustomerRepository.Setup(r => r.AddCustomerAsync(It.IsAny<Customer>())).Returns(Task.CompletedTask);
        ...
        _mockCustomerRepository.Verify(r => r.AddCustomerAsync(It.IsAny<Customer>()), Times.Once);
    }
    ...
    public async Task RegisterAsync_ValidDoctorRegistration_AddsUserAndDoctor()
    {
        ...
        _mockDoctorRepository.Setup(r => r.AddDoctorAsync(It.IsAny<Doctor>())).Returns(Task.CompletedTask);
